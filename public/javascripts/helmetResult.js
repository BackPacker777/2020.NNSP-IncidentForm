...
class helmetResult {
    ...
    //INJURED PERSON
        ...
        if (sessionStorage.getItem('ability') === 'Beginner') {
            document.getElementById('ability').innerText = 'Beginner';
        } else if (sessionStorage.getItem('ability') === 'Intermediate') {
            document.getElementById('ability').innerText = 'Intermediate';
        } else if (sessionStorage.getItem('ability') === 'Expert') {
            document.getElementById('ability').innerText = 'Expert';
        }
        ...
        if (sessionStorage.getItem('whichHill')) {
            location = sessionStorage.getItem('whichHill');
        } else if (sessionStorage.getItem('whichLift')) {
            location = sessionStorage.getItem('whichLift');
        } else {
